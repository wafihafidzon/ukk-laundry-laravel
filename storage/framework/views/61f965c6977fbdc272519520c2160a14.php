...
unset($__errorArgs, $__bag); ?>" wire:model="test" placeholder="<?php echo e($nama_paket); ?>">
                    <?php echo e($test); ?>

                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['nama_paket'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" wire:model="jenis" placeholder="<?php echo e($jenis); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        wire:model="harga" placeholder="<?php echo e($harga); ?>">
...
<?php /**PATH C:\Users\Wafi\Desktop\pplg\learn-livewire\resources\views/livewire/paket/edit.blade.php ENDPATH**/ ?>